...
<div <?php print $attributes; ?>>
  ...
  <div class="clearfix">
    ...
    <dl class="event-details">
      <dt class="title clearfix"><?php print render($content['field_location']['#title']); ?>
        :
      </dt>
      <dd class="description"><?php print render($content['field_location']['#items'][0]['safe_value']); ?></dd>

      <dt class="title clearfix"><?php print render($content['field_cost']['#title']); ?>
        :
      </dt>
      <dd class="description"><?php print render($content['field_cost']['#items'][0]['safe_value']); ?></dd>

      <dt class="title clearfix"><?php print render($content['field_contact']['#title']); ?>
        :
      </dt>

...
Drupal.wysiwyg.editor.instance.tinymce = {
  ...
  getSelectionBookmark: function() {
    return tinyMCE.get(this.getInstanceId()).selection.getBookmark();
  },

  setSelectionBookmark: function(bm) {
    tinyMCE.get(this.getInstanceId()).selection.moveToBookmark(bm);
  }
};

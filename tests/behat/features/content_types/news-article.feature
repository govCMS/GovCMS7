Feature: News Article
  ...
  Scenario: Create News Article content and check how it's displayed.
    ...
    And I should see "19 November 2016"
  ...
  Scenario: Scheduling a node for publishing.
    ...
    And I schedule the node to be published at "2099-12-31 08:57:00"
    And I press "Save"
    Then I should see the message containing "This post is unpublished and will be published 2099-12-31 08:57:00."

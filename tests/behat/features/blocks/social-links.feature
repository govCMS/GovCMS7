Feature: Social Media Links
  ...
  Scenario: The social media links block should be available OOTB
    ...
    And the response should contain "/profiles/govcms/modules/custom/govcms_social_links/images/facebook.png\" alt=\"Facebook\" title=\"Facebook\""
    And the response should contain "<a href=\"http://example.com/twitter\"><img typeof=\"foaf:Image\" src=\""
    And the response should contain "/profiles/govcms/modules/custom/govcms_social_links/images/twitter.png\" alt=\"Twitter\" title=\"Twitter\""
    And the response should contain "<a href=\"http://example.com/youtube\"><img typeof=\"foaf:Image\" src=\""
    And the response should contain "/profiles/govcms/modules/custom/govcms_social_links/images/youtube.png\" alt=\"Youtube\" title=\"Youtube\""
    And the response should contain "<a href=\"http://example.com/vimeo\"><img typeof=\"foaf:Image\" src=\""
    And the response should contain "/profiles/govcms/modules/custom/govcms_social_links/images/vimeo.png\" alt=\"Vimeo\" title=\"Vimeo\""
    And the response should contain "<a href=\"http://example.com/flickr\"><img typeof=\"foaf:Image\" src=\""
    And the response should contain "/profiles/govcms/modules/custom/govcms_social_links/images/flickr.png\" alt=\"Flickr\" title=\"Flickr\""
    And the response should contain "<a href=\"http://example.com/instagram\"><img typeof=\"foaf:Image\" src=\""
    And the response should contain "/profiles/govcms/modules/custom/govcms_social_links/images/instagram.png\" alt=\"Instagram\" title=\"Instagram\""
    And the response should contain "<a href=\"http://example.com/linkedin\"><img typeof=\"foaf:Image\" src=\""
    And the response should contain "/profiles/govcms/modules/custom/govcms_social_links/images/linkedin.png\" alt=\"Linkedin\" title=\"Linkedin\""
    And the response should contain "<a href=\"http://example.com/rss\"><img typeof=\"foaf:Image\" src=\""
    And the response should contain "/profiles/govcms/modules/custom/govcms_social_links/images/rss.png\" alt=\"RSS Feed\" title=\"RSS Feed\""
    And the response should contain "<a href=\"http://example.com/email\"><img typeof=\"foaf:Image\" src=\""
    And the response should contain "/profiles/govcms/modules/custom/govcms_social_links/images/email.png\" alt=\"Email\" title=\"Email\""

...
(function ($, Drupal) {
  ...
  Drupal.behaviors.formalSubmissionToggle = {
    attach: function() {
      ...
      $('#formal-submission-webform  input[id*="remain-anonymous"]').change(function() {
        $('#formal-submission-webform  input[id*="private-submission"]')
          .attr('checked', false);
        if($(this).is(":checked")) {
          $('#formal-submission-webform  input[id*="hys-formal-your-name"]')
            .val('Anonymous')
            .attr('readonly', true);
        } else {
          $('#formal-submission-webform  input[id*="hys-formal-your-name"]')
      ...
      $('#formal-submission-webform  input[id*="private-submission"]').change(function() {
        $('#formal-submission-webform  input[id*="remain-anonymous"]')
          .attr('checked', false);
        if($(this).is(":checked")) {
          $('#formal-submission-webform  input[id*="hys-formal-your-name"]')
  ...
  Drupal.behaviors.formalSubmissionValidation = {
    attach: function(context) {
      ...
      var $form = $('#formal-submission-webform');
